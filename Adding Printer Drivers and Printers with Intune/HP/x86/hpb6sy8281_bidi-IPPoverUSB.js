...
RequestProcessor = function (printerBidiSchemaResponses, pageCache, scriptContext) {
    ...
    this.ValidGetFunctions = "GetSimplePrinterAttributes,GetOctetStringValues2,GetOctetStringValues,GetTrayAttributes,GetAttributeString,MultiStrCompBool,MultiStrCompString,StrCompBool,GetStatusString,SearchAccessoryBins;GetAttributeFromGroup;GetAttributeFromGroupBool;GetStringFromEnumerations;GetCollectionAttributes";
...
PageCache.prototype.FetchIPPContent = function (targetAttrName) {    
	...
	if (null != targetAttrName) {
		if (this.VerifyChannel()) 
		{
			...
			/*IIP Header: dGattributes-charsetutf-8Hattributes-natural-languageenEprinter-uriipp://localhost:80/ipp/printDrequested-attributesprinter-nameD*/
